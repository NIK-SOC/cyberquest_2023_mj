...
class OkHttpClient implements http.Client {
  ...
  Future<http.Response> head(url, {Map<String, String>? headers}) async {
    ...
    return http.Response(okResponse.body!, okResponse.code as int,
  ...
  Future<http.Response> get(Uri url, {Map<String, String>? headers}) async {
    ...
    OkHttpResponse okResponse = await FlutterOkHttpClient().get(okRequest);
    // convert OkHttpResponse to UTF-8
    final utf8Response = utf8.decode(okResponse.body!.codeUnits);

    return http.Response(utf8Response, okResponse.code as int,
        headers: okResponse.headers!);
  }
