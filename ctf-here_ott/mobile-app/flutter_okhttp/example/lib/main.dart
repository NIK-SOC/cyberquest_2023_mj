...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion =
          (await FlutterOkhttp.platformVersion) ?? 'Default Value';
  ...
  Future<void> _onButtonPress() async {
    ...
    FlutterOkhttp().addTrustedHost('ifconfig.co');
    ...
    try {
      ...
      http.Response r = await retryClient
          .get(Uri.parse('https://ifconfig.co/json'))
