    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull rawResult: Result) {
        ...
        return when (call.method) {
            ...
            methodAddTrustedCert -> {
                ...
                if (filename != null) {
                    addTrustedCert(filename)
                    return result.success(null)
                }
                return result.error("FILE_NOT_PROVIDED", "Filename must be provided", null)
            }
            methodRemoveTrustedCert -> {
                val filename = arguments?.get("filename") as? String
                    if (filename != null) {
                        removeTrustedCert(filename)
                        return result.success(null)
                    }
                return result.error("FILE_NOT_PROVIDED", "Filename must be provided.", null)
            }
            methodAddTrustedHost -> {
                ...
                return result.error("HOST_NOT_PROVIDED", "Host must be provided.", null)
            }
